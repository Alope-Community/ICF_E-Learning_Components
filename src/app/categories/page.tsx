    ...
    <section className="bg-gray-100 py-10">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-7 mx-9 my-10">
        <div className="md:flex hidden items-center bg-white p-5 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <img
            src="https://media.istockphoto.com/id/1168757141/id/vektor/trofi-emas-dengan-pelat-nama-pemenang-kompetisi.jpg?s=612x612&w=0&k=20&c=DxJkC-gnLC5YXxZ97uCxx7EZWg5Yxwa2s-HaWFVBpTY="
            alt="UI/UX"
            className="md:w-24 md:h-24 w-16"
          />
          <div className="ml-5">
